...
public class Equipment implements Serializable{
	private int equipCode; //설비 고유 코드 (이걸로 각각의 설비 관리,primary key)
	...
	public Equipment(int equipCode, String equipType, String equipName, String possible, String equipMake) {
		super();
	...
	public String toString() {
		return "Equipment [equipCode=" + equipCode + ", equipType=" + equipType + ", equipName=" + equipName
				+ ", possible=" + possible + ", equipMake=" + equipMake + "]";
	}
