					...
					<div class="loginForm">
						<form id="joinForm" action="<%= request.getContextPath() %>/insertUser.us" method="post">
							<table align="center">
								...
								<tr>
									<td>비밀번호<strong>*</strong><span id="result-pwd1-msg"></span></td>
								</tr>
								<tr>
									<td><input type="password" id="password1" name="password1" size="50" placeholder="영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 8~16자"></td>
								</tr>
								<tr>
									<td>비밀번호 확인<strong>*</strong><span id="result-pwd2-msg"></span></td>
								</tr>
								<tr>
								...
								<tr style="vertical-align: middle;">
									...
									<!-- <button id="juso-btn" style="float: right;" onclick="goPopup();">주소검색</button> -->
...
제1조(목적) 이 약관은 SnackKing 회사가 운영하는 스낵킹 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.

  ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)

  ① “몰”이란 SnackKing 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
제3조 (약관 등의 명시와 설명 및 개정) 
  ...
  ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 스낵킹 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
1. 개인정보 수집 및 이용주체
회원가입을 통해 제공하신 개인정보는 “스낵킹”이 직접 접수하고 관리하며, 수집된 정보는 담당자 이외에는 권한 없이 열람할 수 없습니다.
...
콘텐츠 제공 , 구매 및 요금 결제 , 물품배송 또는 청구지 등 발송 서비스

나. 회원 관리
회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 불량회원의 부정 이용 방지와 비인가 사용 방지 , 가입 의사 확인 , 연령확인 , 불만처리 등 민원처리 , 고지사항 전달

4. 개인정보의 보유 및 이용기간
수집된 정보는 수집 및 이용목적 외의 용도로 이용되지 않으며, 상담신청 후 1년간 보유합니다.

5. 기타
고객사는 개인정보 수집 및 이용 동의를 거부할 수 있으며, 다만 이 경우 서비스이용이 제한될 수 있습니다.
										</textarea>
										<br>
										<label>이용약관에 동의하십니까?</label>
										<input type="checkbox" class="check-btn" name="checkOne"><label>동의함</label>
							...
							<div class="btn-div" align="center">
								<div class="join-btn" id="join-btn" onclick="joinCheck();">회원가입</div><br>
								<div class="cancel-btn" id="cancel-btn" onclick="location.href='login.jsp'">취소하기</div>
							</div>
						</form>
					</div>	<!-- loginForm end -->
