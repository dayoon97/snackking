						...
						<form id="searchForm">
							<table class="memberTable">
								<tr>
									...
									<td style="width: 110px;">계약종료여부  :</td>
									<td>
				...
				<div id="listArea">
					...
					<table id="listTable">
						...
						<tr id="listHead">
							...
							<th width="80px">회사</th>
							<th width="50px">담당자명</th>
							<th width="80px">연락처</th>
							<th width="50px">계약기간</th>
							<th width="100px">계약시작일</th>
							<th width="100px">계약종료일<br>(예정)</th>
							<th width="50px">계약종료</th>
							<th width="50px">정산완료</th>
						</tr>
