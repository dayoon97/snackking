					...
					<div id="searchBox">
						<form id="searchForm">
							<table class="memberTable">
								<tr>
									<!-- 자세한 내용 -->
									<td style="width: 300px;">계약번호</td>
									<td></td>
									<td></td>
									
								</tr>
								<tr>
									<td rowspan="2" style="font-size:40px;">거래처명</td>
									<td>계약 시작일 :</td>
									<td>123</td>					
									<td>총 계약 금액 :</td>
									<td>123</td>	
								...
								<tr>
									<td style="width: 120px;">대여 가능 수량 :</td>
									<td>123</td>	
									<td style="width: 150px;">대여 중인 설비 수 :</td>
									<td>123</td>
								</tr>
							</table>
						</form>
				...
				<div id="listArea">
					...
					<table id="listTable">
						...
						<tr id="listHead">
							...
							<th width="50px">설비ID</th>
							<th width="60px">설비타입</th>
							<th width="80px">재고ID</th>
							<th width="50px">설비명</th>
							<th width="80px">대여 시작일</th>
							<th width="50px">회수 예정일</th>
							<th width="50px">특이사항</th>
						</tr>
