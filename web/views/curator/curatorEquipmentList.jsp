...
<div id="mainWrapper">
	...
	<div id="outer">
		...
		<div id="background-box">
					...
					<div id="searchBox">
						<form id="searchForm">
							<table class="memberTable">
								<tr>
									<!-- 자세한 내용 -->
									<td style="width: 300px;">설비ID</td>
									<td>총 수량 :</td>
									<td>123</td>					
									<td rowspan="3">사진</td>
								</tr>
								<tr>
									<td rowspan="2" style="font-size:40px;">설비명</td>
			...
			<button onclick="" class="searchBtn" id="apply">등록하기</button>
				...
				<div id="listArea">
					...
					<table id="listTable">
						...
						<tr id="listHead">
							...
							<th width="30px">재고ID</th>
							<th width="60px">설비타입</th>
							<th width="80px">설비명</th>
							<th width="50px">입고 날짜</th>
							<th width="80px">상태</th>
							<th width="50px">대여가능여부</th>
