   ...
   <div id="outer">
	...
	<script type="text/javascript">
   	$("#subTitle").click(function() {
		location.href = "<%=request.getContextPath()%>/cuBoardList.bo?num=<%=loginUser.getUserNo()%>";
	});
	...
	$("#searchBtn").click(function() {
		...
		var curatorNo = <%=loginUser.getUserNo()%>
		...
		if(id == "" && type == "" && check == "" && sdate == ""){
			...
			/* $("#searchForm").submit(); */
			$.ajax({
				url: "<%= request.getContextPath()%>/cuSearchList.bo",
				type: "get",
				data: {
					userId: id,
					boardType: type,
