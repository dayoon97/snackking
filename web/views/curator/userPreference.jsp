      ...
      <div id="background-box">
         ...
         <div id="searchArea">
            ...
            <div id="subSubTitle1">내역 조회</div>
               ...
               <div id="searchBox">
                  <form id="searchForm">
                     <table class="memberTable" style="text-align: center;">
                        <tr>
                        	<td width="40px"></td>
                           <!-- 검색 내용 타이핑하는 부분 -->
                           <td width="80px">계약여부 : </td>
                          <!--  <td><input type="text" class="searchTextBox" size="7">
                           ...
                           <td width="30px"></td>
                           <td width="60px">날짜 : </td>
                           <td width="60px"><input type="date"></td>
                           <td width="60px">~</td>
                           <td width="60px"><input type="date"></td>
                           <td><input type="button" id="btn" value="검색하기"></td>
            ...
            <div id="listArea">
               ...
               <table id="listTable">
                  ...
                  <tr id="listHead">
                     ...
                     <th width="60px">선호도 작성일자</th>
                     <th width="80px">계약여부</th>
                     <th width="50px">서비스 시작일</th>
