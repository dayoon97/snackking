...
<div id="mainWrapper">
	...
	<div id="outer">
		...
		<div id="background-box">
			...
			<div id="titleArea">
				...
				<div id="line1"></div>
				<div id="subTitle">교환 관리</div>
			</div>	<!--title-area end -->
			
			<!-- search-area start -->
			<div id="searchArea">
				<!-- 조회 제목 -->
				<div id="subSubTitle1">교환 검색</div>
					<!-- searchBox start -->
					<div id="searchBox">
						<form id="searchForm">
				...
				<div id="listArea">
					...
					<table id="listTable">
						...
						<thead>
							<tr id="listHead">
								<th width="50px">선택</th>
								<th width="180px">리스트코드</th>
								<th width="180px">상품코드</th>
								<th width="180px">상품수량</th>
								<th width="180px">교환코드</th>
	...
	$(function() {
		$(".searchBtn").click(function(){
			...
			$.ajax({
				url: "<%=request.getContextPath()%>/insertExchange.ex",
				data: arr,
				type: "get",
